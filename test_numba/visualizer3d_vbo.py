...
import sdl2.ext
import OpenGL
# Avoid PyOpenGL pointer/context bookkeeping issues with VBO offsets.
OpenGL.ERROR_ON_COPY = True
OpenGL.STORE_POINTERS = False
from OpenGL.GL import *
from OpenGL.GLU import *
from OpenGL.raw.GL.VERSION.GL_1_1 import glVertexPointer as raw_glVertexPointer
from OpenGL.raw.GL.VERSION.GL_1_1 import glColorPointer as raw_glColorPointer
import ctypes
...
class Visualizer3D:
    ...
    def _init_sdl(self):
        ...
        if sdl2.SDL_GL_MakeCurrent(self.window, self.gl_context) != 0:
            raise RuntimeError(f"Erreur SDL_GL_MakeCurrent: {sdl2.SDL_GetError()}")
    ...
    def _render(self):
        ...
        # Binding des VBO
        glBindBuffer(GL_ARRAY_BUFFER, self.vbo_vertices)
        raw_glVertexPointer(3, GL_FLOAT, 0, ctypes.c_void_p(0))
        
        glBindBuffer(GL_ARRAY_BUFFER, self.vbo_colors)
        raw_glColorPointer(3, GL_FLOAT, 0, ctypes.c_void_p(0))
